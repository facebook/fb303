...
struct QuantileConsts {
  ...
  static constexpr const std::array<double, 1> kP9999{{.9999}};
  ...
  static constexpr const std::array<double, 4> kP95_P99_P999_P100{
      {.95, .99, .999, 1}};
  static constexpr const std::array<double, 3> kP95_P99_P100{{.95, .99, 1}};
  static constexpr const std::array<double, 4> kP99_P999_P9999_P100{
      {.99, .999, .9999, 1}};
  static constexpr const std::array<double, 3> kP5_P95_P99{{.05, .95, .99}};
  ...
  static constexpr const std::array<double, 5> kP5_P50_P95_P99_P100{
      {.05, .5, .95, .99, 1}};
  static constexpr const std::array<double, 7> kP5_P50_P95_P99_P999_P9999_P100{
      {.05, .5, .95, .99, .999, .9999, 1}};
  static constexpr const std::array<double, 6> kP5_P50_P95_P99_P9999_P100{
      {.05, .5, .95, .99, .9999, 1}};
  ...
  static constexpr const std::array<double, 5> kP1_P10_P50_P90_P99{
      {.01, .1, .5, .9, .99}};
  static constexpr const std::array<double, 5> kP1_P50_P99{{.01, .5, .99}};
  static constexpr const std::array<double, 5> kP10_P50_P90_P99_P100{
      {.1, .5, .9, .99, 1}};
  static constexpr const std::array<double, 6> kP10_P50_P90_P95_P99_P100{
      {.1, .5, .9, .95, .99, 1}};
  static constexpr const std::array<double, 6> kP1_P10_P75_P90_P95_P99{
      {.01, .1, .75, .9, .95, .99}};
  ...
  static constexpr const std::array<double, 5> kP50_P70_P90_P95_P99{
      {.5, .7, .9, .95, .99}};
  static constexpr const std::array<double, 4> kP50_P90_P99_P100{
      {.5, .90, .99, 1}};
  static constexpr const std::array<double, 4> kP50_P95_P99_P100{
      {.5, .95, .99, 1}};
  static constexpr const std::array<double, 2> kP0_P100{{.0, 1}};
  static constexpr const std::array<double, 3> kP0_P50_P100{{.0, .5, 1.0}};
  static constexpr const std::array<double, 3> kP0_P99_P100{{.0, .99, 1.0}};
  ...
  static constexpr const std::array<double, 8> kP5_P10_P50_P90_P95_P99{
      {.05, .1, .5, .9, .95, .99}};
};
